...
def setup():
    global root, output_label, write_button, sachgebiet, autor, titel, ort, jahr, verlag, antwort
    root = tk.Tk()
...
def insert_buch():
    global sachgebiet, autor, titel, ort, jahr, verlag, antwort
    rows = 0   # hier musst du die Funktion aus deinem Model aufrufen
