...
for year in range(2007, 2023):
    myFiles.append(pandas.read_csv(f"data/Seenberichtsdaten Jahr {year}.csv", encoding='ANSI', sep=";"))
    years.append(year)

for dataFrames in myFiles:
    mask = dataFrames['MESSSTELLE'].str.contains('Magdalenensee|Vassacher See|Silbersee')
...
#print(years)
year07 = myFiles[0]
mask =(year07['MESSSTELLE'].str.contains('Magdalenensee'))  & (year07["PARAMETERBEZEICHNUNG"] == "Wassertemperatur")
